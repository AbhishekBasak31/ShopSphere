...
function Footer(){
    return(
        <footer style={{backgroundColor:"#1976d2",color:"white",padding:"0 2 2 2",}}>
            ...
            <div display={"flex"} padding={5} pt={2} pb={7} justifyContent={"space-between"}  >
                ...
                <div display={"flex"} gap={2} justifyContent={"center"} textAlign={"justify"} padding={2}>
             ...
             <div margin={"auto"} width={"80%"} display={"flex"} justifyContent={"space-between"} alignItems={"center"} pb={2}>
                ...
                <div display={"flex"} gap={2} justifyContent={"center"} alignContent={"center"} >
