    ...
    return(
        <Box className="wrapper" margin={2}>
                    ...
                    <Box className="item1" margin={2} bgcolor={"white"} boxShadow={"0px 1px 2px #949494"}>
                        ...
                        <CARD _id={fisrtCard._id} catagory={fisrtCard.product_catagory} height={"200"} card_height={"100%"} card_width={"100%"}  pic={fisrtCard.product_img} title={fisrtCard.product_name}  alter={fisrtCard.product_name} price={fisrtCard.product_price} discount={fisrtCard.discount}/>
                    </Box>   
                      
                    <Box className="item2" margin={2} bgcolor={"white"} boxShadow={"0px 1px 2px #949494"}>
                    <CARD _id={secondCard._id} catagory={secondCard.product_catagory} height={"200"} card_height={"100%"} card_width={"100%"}  pic={secondCard.product_img} title={secondCard.product_name} alter={secondCard.product_name} price={secondCard.product_price} discount={secondCard.discount}/> 
                    </Box>
                   
                    <Box className="item3" margin={2} bgcolor={"white"} boxShadow={"0px 1px 2px #949494"}>
                    <CARD _id={thirdCard._id} catagory={thirdCard.product_catagory} card_height={"100%"} height={"500"} pic={thirdCard.product_img} title={thirdCard.product_name} alter={thirdCard.product_name} price={thirdCard.product_price} discount={thirdCard.discount}/>

                    </Box>

                    <Box className="item4" margin={2} bgcolor={"white"} boxShadow={"0px 1px 2px #949494"}>
                    <CARD _id={fourthCard._id} catagory={fourthCard.product_catagory} height={"200"} card_height={"100%"} card_width={"100%"} pic={fourthCard.product_img} title={fourthCard.product_name} alter={fourthCard.product_name} price={fourthCard.product_price} discount={fourthCard.discount}/>

                    </Box>
                    
                 
                    <Box className="item5" margin={2} bgcolor={"white"} boxShadow={"0px 1px 2px #949494"}>
                    <CARD  _id={fifthCard._id} catagory={fifthCard.product_catagory}  height={"200"} card_height={"100%"} card_width={"100%"} pic={fifthCard.product_img} title={fifthCard.product_name} alter={fifthCard.product_name} price={fifthCard.product_price} discount={fifthCard.discount}/>
                    </Box>
