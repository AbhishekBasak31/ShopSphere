...
const handleConfirm=()=>{
  ...
  return (
    <div m={"auto"} width={"100%"} height={"auto"}  >

      
      <div display={"flex"}   flexDirection={"column"} gap={10} p={2} justifyContent={"center"} alignItems={"center"}>
        <Typography sx={{display:"block", left:"50px"}} variant="h4">Product Details</Typography>

            {/* Product detail and quantity */}
            <div display={'flex'} gap={2} alignItems={"center"}  justifyContent={"space-evenly"}  borderRadius={"0.23rem"} boxShadow={"0px 1px 2px #949494"} p={5} width={'95%'}>

              <div>{Product.product_img&&<img src={Product.product_img} width={250} height={250}/>}</div>

              <div display={'flex'} flexDirection={"column"} justifyContent={"left"} alignItems={"left"} textAlign={"justify"} gap={4} width={"50%"}>
          ...
          <div display={"flex"} alignItems={"center"} justifyContent={"space-between"}gap={10} borderRadius={"0.23rem"} boxShadow={"0px 1px 2px #949494"} p={5} width={'95%'}>

            <div p={2} width={"33%"}>
            <Typography  variant="h5">{userData?userData.user_name:"NO name found"}</Typography>
            </div>
            <div width={"33%"} p={2} display={"flex"} flexDirection={"column"} alignItems={"left"} justifyContent={"left"} textAlign={"justify"} >
        ...
        <div display={'flex'} gap={20} justifyContent={"center"}>
