...
function Product_By_Id(){
    ...
    return (
        <>
            <div margin={"auto"} width={"95%"} height={"auto"}  p={12} mt={18} bgcolor={"white"} display={"flex"} flexDirection={"column"} gap={3} padding={2} justifyContent={"center"} alignItems={"center"}>
               
                {!isChildRouteActive&&(
                <div display={"flex"} gap={5} padding={2} width={"100%"} justifyContent={"center"}>
                    <div width={"50%"} sx={{ boxShadow: "0.2px 0.2px 1px 1px  #949494" }} padding={3} display={"flex"} flexDirection={"column"} gap={3} alignItems={"center"}>
                        {Product.product_img && <img src={Product.product_img} alt="" width={500} height={500} />}
                        <div display={"flex"} gap={3} pb={1}>
                    ...
                    <div width={"50%"} display={"flex"} flexDirection={"column"} alignItems={"flex-start"} gap={5} sx={{ textAlign: "justify" }}>
